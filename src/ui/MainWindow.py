...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBoxShopType.setItemText(6, _translate("MainWindow", "考虑工人的作业车间"))
        self.comboBoxShopType.setItemText(7, _translate("MainWindow", "考虑工人的柔性作业车间"))
        self.label.setText(_translate("MainWindow", "车间类型"))
        self.comboBoxDataSource.setItemText(0, _translate("MainWindow", "输入数据"))
        self.comboBoxDataSource.setItemText(1, _translate("MainWindow", "均匀分布"))
        self.comboBoxDataSource.setItemText(2, _translate("MainWindow", "标准算例"))
